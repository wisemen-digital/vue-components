...
import { useToastSwipe } from '@/composables/toast/useToastSwipe'
...
<template>
  <div ref="toastContainerElement" class="relative">
    <div
      ref="toastElement"
    ...
    >
      ...
      >
        ...
        <div class="flex items-center gap-1">
          ...
          <AppButton size="icon" variant="ghost" @touchstart="handleClose" @click="handleClose">
