const __resolved__virtual_storySource_srcComponentsButtonAppbuttonStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsButtonAppbuttonStoryVue as default
};
