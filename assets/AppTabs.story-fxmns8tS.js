import { au as defineComponent, bl as me, aw as openBlock, ax as createBlock, ay as withCtx, aH as renderSlot, bm as pe, aU as computed, bn as xe, bo as RouterLink, aN as Transition, aD as guardReactiveProps, aC as normalizeProps, aG as createElementBlock, aI as createCommentVNode, az as createVNode, aJ as normalizeClass, bp as resolveDynamicComponent, bq as Ie, br as useRouteQuery, b7 as watch, aK as mergeModels, aL as useModel, bs as useRoute, bt as RouterView, aP as Fragment, aF as toDisplayString, aB as createBaseVNode, bi as renderList, bu as ye, aQ as ref, av as resolveComponent } from "./vendor-Ltpks1HC.js";
import { A as AppIcon } from "./AppIcon-a4cW9fH1.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    watch(() => route == null ? void 0 : route.path, () => {
      if (!isUsingRouter.value)
        return;
      const tab = allTabs.value.find((tab2) => {
        return route == null ? void 0 : route.matched.find((route2) => {
          return tab2.to === (route2 == null ? void 0 : route2.path);
        });
      });
      if (tab)
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock($setup["AppTabsGroup"], {
    ...
    default: withCtx(() => [
      createVNode($setup["AppTabsList"], { class: "bg-background text-foreground" }, {
        default: withCtx(() => [
