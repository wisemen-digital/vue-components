import { _ as __vitePreload, Q as Comp12, R as defineAsyncComponent, S as createRouter, U as createWebHistory, V as createWebHashHistory, W as useDark, X as useToggle, k as watch, Y as markRaw, E as reactive, d as defineComponent, r as ref, Z as watchEffect, o as openBlock, q as createBlock, $ as mergeProps, a0 as resolveDynamicComponent, h as createCommentVNode } from "./vendor-tZ123Fjd.js";
const Comp8 = { "icon": "carbon:information", "group": "top", "docsOnly": true, "variants": [] };
...
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor-tZ123Fjd.js").then((n) => n.bn), true ? __vite__mapDeps([]) : void 0),
  "vue3": () => __vitePreload(() => import("./vendor-tZ123Fjd.js").then((n) => n.bo), true ? __vite__mapDeps([]) : void 0)
};
const __default__ = {
  inheritAttrs: false
};
