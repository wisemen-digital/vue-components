const __resolved__virtual_storySource_srcComponentsAppButtonAppbuttonStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsAppButtonAppbuttonStoryVue as default
};
