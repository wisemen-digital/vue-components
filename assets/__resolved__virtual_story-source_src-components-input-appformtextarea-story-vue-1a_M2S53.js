const __resolved__virtual_storySource_srcComponentsInputAppformtextareaStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsInputAppformtextareaStoryVue as default
};
