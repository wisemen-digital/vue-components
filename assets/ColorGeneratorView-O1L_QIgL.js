import { au as defineComponent, aQ as ref, b7 as watch, aw as openBlock, aG as createElementBlock, aB as createBaseVNode, aW as withDirectives, bB as vModelCheckbox, aP as Fragment, bi as renderList, az as createVNode, ay as withCtx, aE as createTextVNode, aF as toDisplayString, aX as vModelText, ax as createBlock } from "./vendor-Ltpks1HC.js";
import { A as AppInput } from "./AppInput-b06Ug9Kg.js";
import { A as AppButton } from "./AppButton-0SYbiXhr.js";
...
function mapCssVariablesBodyIntoArray(globalsCss) {
  const globalsCssArray = globalsCss.split(";");
  const globalsCssArrayFiltered = globalsCssArray.filter((item) => item.includes("--")).map((item) => item.trim().replace(";", "").split(":")).map((item) => {
    return {
      name: item[0].trim(),
...
function convertCssIntoVariables(globalsCss, isBody = false) {
...
function combineStyles(firstCss, secondCss) {
  const allHsl = [];
  const allOther = [];
...
function setBodyCssVariables(cssVariables) {
...
${cssVariable.name}: ${cssVariable.value};`;
    ...
    const __returned__ = { getGlobalConfig, globalsCss, defaultValues, hslCssVariables, otherValues, init, useColorInput, generateCss, handleDownloadCss, handleCssUpload, setCss, FormInputField: AppInput, AppButton };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createBaseVNode("div", _hoisted_2, [
      ...
      createVNode($setup["AppButton"], { onClick: $setup.setCss }, {
        default: withCtx(() => [
          createTextVNode(" Set CSS ")
        ]),
        _: 1
        /* STABLE */
      })
...
_sfc_main.__file = "src/color-generator/views/ColorGeneratorView.vue";
const ColorGeneratorView = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/home/runner/work/vue-components/vue-components/src/color-generator/views/ColorGeneratorView.vue"]]);
export {
  ColorGeneratorView as default
};
