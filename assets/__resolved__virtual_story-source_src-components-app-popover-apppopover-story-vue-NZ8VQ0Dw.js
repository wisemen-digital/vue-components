const __resolved__virtual_storySource_srcComponentsAppPopoverApppopoverStoryVue = `<script setup lang="ts">
import { reactive } from 'vue'
import type { Props } from '@/components/app/popover/AppPopover.vue'
import AppPopover from '@/components/app/popover/AppPopover.vue'
...
`;
export {
  __resolved__virtual_storySource_srcComponentsAppPopoverApppopoverStoryVue as default
};
