const __resolved__virtual_storySource_srcComponentsInputAppinputStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsInputAppinputStoryVue as default
};
