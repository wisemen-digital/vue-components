import { au as defineComponent, aw as openBlock, aI as createBlock, aE as withCtx, aD as createVNode, aG as toDisplayString, aF as createTextVNode, aO as createCommentVNode, ay as createBaseVNode, ax as createElementBlock, aU as computed, aP as normalizeClass } from "./vendor-eGJvRIAJ.js";
import { A as AppIcon } from "./AppIcon-0BVF7wuw.js";
import { A as AppText } from "./AppText-YE5baG2E.js";
import { A as AppHeightTransition } from "./AppHeightTransition-E_mzh99q.js";
...
const _hoisted_2 = { class: "mt-1 flex items-center gap-x-2" };
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock($setup["AppHeightTransition"], { duration: 0.2 }, {
    default: withCtx(() => [
      $props.errors != null && $props.isTouched ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
...
_sfc_main$1.__file = "src/components/form-error/AppFormError.vue";
const AppFormError = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__file", "/home/runner/work/vue-components/vue-components/src/components/form-error/AppFormError.vue"]]);
const formLabel = cva({
