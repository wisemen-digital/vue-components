const __resolved__virtual_storySource_srcComponentsRadioAppformradiogroupStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsRadioAppformradiogroupStoryVue as default
};
