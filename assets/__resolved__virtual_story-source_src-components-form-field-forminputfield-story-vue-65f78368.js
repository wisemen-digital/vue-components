const __resolved__virtual_storySource_srcComponentsFormFieldForminputfieldStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsFormFieldForminputfieldStoryVue as default
};
