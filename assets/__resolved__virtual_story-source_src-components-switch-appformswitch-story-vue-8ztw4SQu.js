const __resolved__virtual_storySource_srcComponentsSwitchAppformswitchStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsSwitchAppformswitchStoryVue as default
};
