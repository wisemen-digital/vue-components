const __resolved__virtual_storySource_srcComponentsTextApptextStoryVue = `<script setup lang="ts">
import { reactive } from 'vue'
import { textBoldnessOptions, textTruncateOptions, textVariantOptions } from '@/components/text/appText.style'
...
`;
export {
  __resolved__virtual_storySource_srcComponentsTextApptextStoryVue as default
};
