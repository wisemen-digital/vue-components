const __resolved__virtual_storySource_srcComponentsModalAppmodalStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsModalAppmodalStoryVue as default
};
