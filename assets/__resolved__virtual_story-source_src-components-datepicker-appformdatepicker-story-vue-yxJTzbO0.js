const __resolved__virtual_storySource_srcComponentsDatepickerAppformdatepickerStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsDatepickerAppformdatepickerStoryVue as default
};
