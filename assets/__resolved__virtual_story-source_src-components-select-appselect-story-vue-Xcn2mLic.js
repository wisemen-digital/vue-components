const __resolved__virtual_storySource_srcComponentsSelectAppselectStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsSelectAppselectStoryVue as default
};
