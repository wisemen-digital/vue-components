const __resolved__virtual_storySource_srcComponentsAppModalAppmodalStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsAppModalAppmodalStoryVue as default
};
