const __resolved__virtual_storySource_srcComponentsCardAppcardStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsCardAppcardStoryVue as default
};
